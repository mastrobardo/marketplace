 ...
 * `@storybook/addon-a11y` rides on that project: with `parameters.a11y.test = 'error'` in
 * `preview.tsx`, axe runs against every rendered story and a violation fails the build (`W12-T04`).
 */
