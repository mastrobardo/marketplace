...
- `W3-T07` `[A]` Provider profile **API** — badges, portfolio, reviews and response time as `GET /providers/:slug`. The *page* is `W12-T12`, for the same reason as `W3-T06`: ADR-011 §1 exists because UI work sitting as an unstated tail on an API ticket is how thirteen agents each invent their own button
